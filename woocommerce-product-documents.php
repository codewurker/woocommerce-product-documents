 ...
 * Documentation URI: https://docs.woocommerce.com/document/woocommerce-product-documents/
 ...
 * @author    SkyVerge
 * @copyright Copyright (c) 2013-2024, Inc. (info@skyverge.com)
 ...
 * @since 1.9.0
 */
class WC_Product_Documents_Loader {
	...
	/** @var \WC_Product_Documents_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-product-documents.php' );
	 ...
	 * @since 1.9.0
	 *
	 * @return \WC_Product_Documents_Loader
	 */
...
// fire it up!
WC_Product_Documents_Loader::instance();
